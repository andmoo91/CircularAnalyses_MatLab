...
myFolder = '/Users/asmoore/Desktop/ER-Mito covariance/CytoD/32Bit_ERUltima';
myFolder2 = '/Users/asmoore/Desktop/ER-Mito covariance/CytoD/MitoDistanceMaps';
filePattern = fullfile(myFolder,'*.tif'); % ultimate points of ER cisterna
filePattern2 = fullfile(myFolder2,'*.tif'); % EDM of mito
...
for k=1:length(theFiles)
    ...
    Ultimate = double(imageArray);
    [ux uy uv]=find(Ultimate);
    maxuv(k,1)=max(uv);
    EDM = double(imageArray2);
